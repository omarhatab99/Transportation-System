...
namespace TransportReservationSystem.Pages.Booking
{
    public partial class FrmInterState : Form
    {
        ...
        private void FrmInterState_Load(object sender, EventArgs e)
        {
            ...
            AvailableSeatLBL.Text = Convert.ToString(trip.AvailableSeats);
            LblCapcity.Text = Convert.ToString(trip.Vehicle.Category.Capacity);
            SelectedSeats.Clear();
            ...
            if (isReserverd == null)
            {
                if (currentButton.BackColor == Color.Green) //Reserved
                {
                    ...
                    if (trip.AvailableSeats > 0)
                    {
                        ...
                        AvailableSeatLBL.Text = Convert.ToString((Convert.ToInt32(AvailableSeatLBL.Text) - 1));
